...
static s32 parse_config_line(char *current_line, char *current_variable,
 char *current_value);
static s32 load_gamepak_raw(char *name);
static u32 evict_gamepak_page();
static void init_memory_gamepak();
...
const u8 gamepak_waitstate_seq[2][2][3] =
{
  {
    { 3, 5, 9 }, { 5, 9,17 }
  },
...
const u8 gba_md5[16] = { 0xA8, 0x60, 0xE8, 0xC0, 0xB6, 0xD5, 0x73, 0xD1,
                         0x91, 0xE4, 0xEC, 0x7D, 0xB1, 0xB1, 0xE4, 0xF6 };
const u8 nds_md5[16] = { 0x1C, 0x0D, 0x67, 0xDB, 0x9E, 0x12, 0x08, 0xB9,
...
#define read_open32()                                                         \
  ...
  {                                                                           \
    ...
    value = (current_instruction << 16) | current_instruction;                \
  }                                                                           \
  else                                                                        \
  {                                                                           \
...
CPU_ALERT_TYPE write_io_register8(u32 address, u32 value)
{
  switch(address)
  {
    case 0x00:
    {
      u32 bg_mode = io_registers[REG_DISPCNT] & 0x07;
...
//    FILE_CLOSE(gamepak_file_large);
  ...
  clear_screen(0x0000);
  print_string(msg[MSG_LOADING_ROM], 0xFFFF, 0x0000, 10, 10);
