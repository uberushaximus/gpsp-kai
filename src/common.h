...
#define DBGOUT(...) if(g_gpsp_config.debug_flag != NO) fprintf(g_dbg_file, __VA_ARGS__)
#define DBGOUT_1(...) if(g_gpsp_config.debug_flag >= 1) fprintf(g_dbg_file, __VA_ARGS__)
#define DBGOUT_2(...) if(g_gpsp_config.debug_flag >= 2) fprintf(g_dbg_file, __VA_ARGS__)
#define DBGOUT_3(...) if(g_gpsp_config.debug_flag >= 3) fprintf(g_dbg_file, __VA_ARGS__)
#define DBGOUT_4(...) if(g_gpsp_config.debug_flag >= 4) fprintf(g_dbg_file, __VA_ARGS__)
#define DBGOUT_5(...) if(g_gpsp_config.debug_flag >= 5) fprintf(g_dbg_file, __VA_ARGS__)
FILE *g_dbg_file;
